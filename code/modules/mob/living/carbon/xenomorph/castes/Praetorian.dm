...
/mob/living/carbon/Xenomorph/Praetorian/process_ai(delta_time, game_evaluation)
	. = ..()
	...
	if(DT_PROB(PRAETORIAN_SPRAY, delta_time))
		var/datum/action/xeno_action/A = get_xeno_action_by_type(src, /datum/action/xeno_action/activable/spray_acid/base_prae_spray_acid)
		A.use_ability_async(current_target)
